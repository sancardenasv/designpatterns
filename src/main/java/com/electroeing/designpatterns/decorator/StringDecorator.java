...
public class StringDecorator {
    private final static Logger logger = LoggerFactory.getLogger(StringDecorator.class);

    public static void main(String[] args) {
        MagicString string = new MagicString("hello");

        logger.info("String '{}' has a total of {} vowels", string, string.getNumberOfVowels());
